...
Repositorio central de proyectos web enfocados en diseño responsive, usabilidad y buenas prácticas de desarrollo frontend.

<br>

 * Lenguajes : HTML, CSS, JavaScript, otros.
 * Frameworks : Bootstrap, otros.
 * Herramientas : VS Code, Git, Heroku, Netlify, otros.
...
<a id="sitio-web-de-robotica"></a>
### Sitio Web de Robótica ![status-completed](../doc/assets/icons/badges/status-completed.svg) [🔝](#index)
